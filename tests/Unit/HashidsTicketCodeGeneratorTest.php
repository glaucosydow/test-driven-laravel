...
class HashidsTicketCodeGeneratorTest extends TestCase
{
    ...
    /** @test */
    public function ticket_codes_should_contain_only_uppercase_letters()
    {
        $ticketCodeGenerator = new HashidsTicketCodeGenerator('testsalt1');
    ...
    /** @test */
    public function ticket_codes_are_identical_for_the_same_ticket_id()
    {
        $ticketCodeGenerator = new HashidsTicketCodeGenerator('testsalt1');
    ...
    /** @test */
    public function ticket_codes_are_different_for_different_ticket_ids()
    {
        $ticketCodeGenerator = new HashidsTicketCodeGenerator('testsalt1');
